            ...
            <div key={index}>
              ...
              >
                ...
                <a
                  ...
                  target='_blank'
                  rel='noopener noreferrer'
                  className='flex flex-row w-full md:w-fit justify-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ease-in-out rounded-lg'
                >
                  <Image
                    src={img}
                    alt={name}
